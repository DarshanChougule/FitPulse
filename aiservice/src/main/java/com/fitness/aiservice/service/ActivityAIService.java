...
public class ActivityAIService {
    ...
    private Recommendation processAiResponse(Activity activity,String aiResponse){
        ...
        return Recommendation.builder()
                .activityId(activity.getId())
                    .userId(activity.getUserId())
                    .activityType(activity.getType())
                    .recommendation("Unable to genrate recommendation")
                    .improvements(Collections.singletonList("Continue with your daily routine"))
                    .suggestion(Collections.singletonList("Consider Consislting"))
                    .saftey(Arrays.asList("Always warmup before exercise", 
                                    "Stay Hydrated",
                                    "Listen to your body"))
                    .build();
    }
    ...
    private List<String> extractSafety(JsonNode safetyNode) {
      ...
      return safety.isEmpty() ? Collections.singletonList("Follow general safety guidlines") : safety;
    }
